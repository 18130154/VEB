...
$schiotchik=0;
        ...
        foreach ($rrow->review as $number => $item) {
            ...
            $email = $item->email;
            $rev = $item->rev;
            echo "<div style='width: 90%; border: 3px solid #000; padding:10px' >";
            echo '<span style="font-weight: bold;">Имя: </span>'.$name.'<br><span style="font-weight: bold;">email: </span>'.$email.'<br><span style="font-weight: bold;">Пожелание: </span>'.$rev.'<br>';  
            echo "</div><br>";
